<template>
  <div class="flex min-h-screen flex-col items-center justify-center p-10 text-center md:px-24">
    <p class="text-4xl font-bold leading-loose tracking-tight md:text-8xl">
      Lukajaa
